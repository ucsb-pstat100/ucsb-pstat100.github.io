...
-   So, here's a way we can use the Bootstrap to obtain a _p_ CI:
    ...
    2)    Use the (1 - _p_)/2 and 1 - (1 + _p_)/2 quantiles of the bootstraped sampling distribution
...
In this live demo, we'll construct a bootstrap confidence interval for the proportion of cats that have FIV (Feline Immunodeficiency Virus). As always, please feel free to boot up your laptop and follow along!
:::

-   You'll get more practice with CIs (and boostrapping CIs) in a future lab.
