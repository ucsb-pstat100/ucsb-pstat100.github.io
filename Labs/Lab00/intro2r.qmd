...
-   R4DS, [Chapter 27: A field guide to base R](https://r4ds.hadley.nz/base-r)
...
We've posted a separate lab covering even more operations on dataframes, which can be accessed [here](google.com).
